...
# Quantlet:     STFloss06
# ---------------------------------------------------------------------
# Description:  STFloss06 plots three sample Burr pdfs, Burr(alpha,
#               lambda, tau), on linear and double-logarithmic scales 
#               and three sample Weibull pdfs, Weib(beta, tau), on a 
#               linear and semi-logarithmic scales. We can see that for
#               tau<1 the tails are much heavier and they look like
#               power-law.
# ---------------------------------------------------------------------
# Usage:        -
# ---------------------------------------------------------------------
...
# Inputs:       none
# ---------------------------------------------------------------------
# Output:       Plots of three sample Burr pdfs, Burr(alpha,
#               lambda, tau), on linear and double-logarithmic scales 
#               and three sample Weibull pdfs, Weib(beta, tau), on a 
#               linear and semi-logarithmic scales. We can see that for
#               tau<1 the tails are much heavier and they look like
...
dev.new()
plot(x,y1,log="xy", col="black", type="l", lwd=2, xlab="x", ylab="PDF(x)", ylim=c(10e-5,10e-1),xlim=c((10e-2), (10e1)))
par(new=T)
plot(x,y2, type="l", log="xy", axes=F,frame=F,ylab="",xlab="",col="red3", lty=3,lwd=2,ylim=c(10e-5,10e-1),xlim=c((10e-2), (10e1)))
par(new=T)
plot(x,y3, type="l", log="xy", axes=F,frame=F,ylab="",xlab="",col="blue3", lty=2,,lwd=2,ylim=c(10e-5,10e-1),xlim=c((10e-2), (10e1)))
title("Burr densities")
...
dev.new()
plot(x,y1,log="y", col="black", type="l", lwd=2, xlab="x", ylab="PDF(x)", ylim=c(10e-4,10e-1),xlim=c(0,5))
par(new=T)
plot(x,y2, type="l", log="y", axes=F,frame=F,ylab="",xlab="",col="red3", lty=3,lwd=2,ylim=c(10e-4,10e-1),xlim=c(0,5))
par(new=T)
plot(x,y3, type="l", log="y", axes=F,frame=F,ylab="",xlab="",col="blue3", lty=2,,lwd=2,ylim=c(10e-4,10e-1),xlim=c(0,5))
title("Weibull densities")
