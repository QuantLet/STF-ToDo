...
% Quantlet:     STFstab04
% ---------------------------------------------------------------------
% Description:  STFstab04 plots densities and log-densities of symmetric
%               hyperbolic, TSD, NIG and Gaussian distributions having
%               the same variance.
% ---------------------------------------------------------------------
% Usage:        ghypstat.m (requires besselk.m from Symbolic Math toolbox),
%               hyppdf.m, nigpdf.m, tstabpdf3.m
% ---------------------------------------------------------------------
% See also:     ghypstat, hyppdf, nigpdf, tstabpdf3, STFstab01, STFstab03
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Plots of densities and log-densities of symmetric
%               hyperbolic, TSD, NIG and Gaussian distributions having
%               the same variance.
% ---------------------------------------------------------------------
% Example:      -
