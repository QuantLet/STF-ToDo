...
#             computes price of the coupon-bearing CAT bond for the given 
#             claim amount distribution and non-homogeneous 
...
wireframe(z~x+y, data=data, screen = list(z = 55, x = -60),
