...
% Quantlet:     STFhes03
% ---------------------------------------------------------------------
% Description:  STFhes03 Compares the option prices obtained using the
%               analytical Heston formula (1993) and the FFT method
%               (Carr-Madan formula via FFT + Simpson's, Carr-Madan
%               using adaptive Gauss-Kronrod quadrature, and Lipton's
%               formula using adaptive Gauss-Kronrod quadrature).
% ---------------------------------------------------------------------
% Usage:        HestonFFTVanilla.m, HestonVanillaLipton.m, HestonVanilla.m
% ---------------------------------------------------------------------
% See also:     HestonFFTVanilla, HestonVanillaLipton, HestonVanilla
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Comparison of the option prices obtained using the
%               analytical Heston formula (1993) and the FFT method
%               (Carr-Madan formula via FFT + Simpson's, Carr-Madan using
%               adaptive Gauss-Kronrod quadrature, and Lipton's formula 
%               using adaptive Gauss-Kronrod quadrature).
% ---------------------------------------------------------------------
% Example:      -
% ---------------------------------------------------------------------
% Author:       Rafal Weron, Agnieszka Janek 20100727
%               Revised: Rafal Weron, Agnieszka Janek 20101022
% ---------------------------------------------------------------------
