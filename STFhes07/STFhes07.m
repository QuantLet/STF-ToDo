...
% Quantlet:     STFhes07
% ---------------------------------------------------------------------
% Description:  STFhes07 plots the EUR/USD market smile on July 22, 2010
%               and the fit obtained with the Heston model for
%               tau = 1 week (figure 1, top left panel), 1 month (figure 1,
%               top right panel), 3 months (figure 1, bottom left panel),
%               6 months (figure 1, bottom right panel), 1 year (figure 2
%               top left panel), 2 years (figure 2, top right panel),
%               the term structure of the volatility of volatility and the
%               correlation visualizing the problem of fitting the smile in
%               the short term (figure 2, bottom panels)
% ---------------------------------------------------------------------
% Usage:        HestonVanillaFitSmile.m
% ---------------------------------------------------------------------
% See also:     HestonVanillaFitSmile
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Plots of the EUR/USD market smile on July 22, 2010
%               and the fit obtained with the Heston model for
%               tau = 1 week (figure 1, top left panel), 1 month (figure 1,
%               top right panel), 3 months (figure 1, bottom left panel),
%               6 months (figure 1, bottom right panel), 1 year (figure 2
...
% Example:      -
% ---------------------------------------------------------------------
% Author:       Agnieszka Janek 20100707
%               Revised: Rafal Weron 20100728, 20101116
% ---------------------------------------------------------------------
