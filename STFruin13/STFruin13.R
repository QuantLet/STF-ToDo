...
# Quantlet:     STFruin13
# ------------------------------------------------------------------------------
# Description:  STFruin13 produces the ruin probability in infinite time for 
#               mixture of 2 exponentials distribution claims given by light
...
#               distribution claims given by light traffic approximation.
# ------------------------------------------------------------------------------
# Example:      
# ------------------------------------------------------------------------------
