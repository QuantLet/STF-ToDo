...
# Quantlet:     STF2tvch07
# ------------------------------------------------------------------------------
# Description:  STF2tvch07 Evaluates the mean absolute forecast errors of the AWS 
#				model for SP500 data in years 2001--2005 and plots the forecasted  
#				volatility.
#               
# ------------------------------------------------------------------------------
# Usage:        -
...
#
# ------------------------------------------------------------------------------
# Output:       Plot of mean absolute forecast errors in the AWS model for SP500 data
#				
# ------------------------------------------------------------------------------
...
# SP500 data in years 2001--2005; it plots the forecasted volatility too.
