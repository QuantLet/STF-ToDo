...
% Quantlet:     STFstab06
% ---------------------------------------------------------------------
% Description:  STFstab06 plots (log)-returns of WIG20 index with
%               GARCH(1,1)-based daily volatility estimate sigma_t 
%               (figure 1, left panel), as well as sigma_t filtered WIG20
...
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Plots of (log)-returns of WIG20 index with
%               GARCH(1,1)-based daily volatility estimate sigma_t 
%               (figure 1, left panel), as well as sigma_t filtered WIG20
