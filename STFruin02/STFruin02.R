...
# Quantlet:     STFruin02
# ------------------------------------------------------------------------------
# Description:  STFruin02 produces the exact ruin probability in infinite time  
...
# Inputs:       None    
# ------------------------------------------------------------------------------
# Output:       Exact ruin probability in infinite time for exponential claims.
# ------------------------------------------------------------------------------
# Example:      -
# ------------------------------------------------------------------------------
...
ruinexp<-function(u,theta,beta){
	...
	# beta: parameter for exponential loss distribution
...
beta1<-6.3780e-09                         # parameter for exponential loss distribution

# ruin probability in infinite time for exponential claims with beta=6.3780e-09 and theta=0.3 (u in USD)
