...
# Quantlet:     STFruin11
# ------------------------------------------------------------------------------
# Description:  STFruin11 produces the ruin probability in infinite time for 
#               mixture of 2 exponentials distribution claims given by
...
#               distribution claims given by 4-moment gamma De Vylder 
#               approximation.
# ------------------------------------------------------------------------------
# Example:      -
# ------------------------------------------------------------------------------
# Author:       Zografia Anastasiadou 20110809
# ------------------------------------------------------------------------------
...
# the 4-moment gamma De Vylder approximation for mixture of 2 exponentials claims with beta1=3.5900e-10, beta2=7.5088e-09, alpha=0.0584 and theta=0.3 (u in USD) 
