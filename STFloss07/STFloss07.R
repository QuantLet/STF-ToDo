...
# Quantlet:     STFloss07
# ---------------------------------------------------------------------
# Description:  STFloss07 plots in a first panel shapes of the mean 
#               excess function e(x) for the log-normal, gamma 
#               (with alpha<1 & alpha>1) and a mixture of two exponential
#               distributions. The second panel illustrates shapes of the
#               mean excess function e(x) for the Pareto, Weibull (with 
#               tau<1 and tau>1) and the Burr distribution.
# ---------------------------------------------------------------------
# Usage:        -
# ---------------------------------------------------------------------
...
# Inputs:       none
# ---------------------------------------------------------------------
# Output:       First panel shows shapes of the mean excess function 
#               e(x) for the log-normal, gamma (with alpha<1 & alpha>1)
#               and a mixture of two exponential distributions.
#               The second panel illustrates shapes of the mean excess 
#               function e(x) for the Pareto, Weibull (with tau<1 and 
#               tau>1) and the Burr distribution.    
# ---------------------------------------------------------------------
# Example:      -
# ---------------------------------------------------------------------
...
#       mean excess function for the distribution specified by IND:
#       1-lognormal, 2-gamma, 3-weibull, 4-pareto, 5-Burr, 6-mixture
#       of exponential distributions with parameters PARAM1,
#       PARAM2, PARAM3. 
