...
% Quantlet:     STFstab02
% ---------------------------------------------------------------------
% Description:  STFstab02 shows a semi-logarithmic plot of symmetric
%               (beta=mu=0) stable densities for four values of alpha 
%               (Note the distinct behavior of the Gaussian (alpha = 2)
%               distribution) and a plot of stable densities for 
%               alpha = 1.2 and four values of beta.
% ---------------------------------------------------------------------
% Usage:        stabpdf_fft.m
% ---------------------------------------------------------------------
% See also:     stabpdf_fft, STFstab01, STFstab03
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       a semi-logarithmic plot of symmetric (beta=mu=0) stable 
%               densities for four values of alpha (Note the distinct
%               behavior of the Gaussian (alpha = 2) distribution);
%               and a plot of stable densities for alpha = 1.2 and 
%               four values of beta.
% ---------------------------------------------------------------------
% Example:      -
% ---------------------------------------------------------------------
