...
# Quantlet:     STFdmm04
# ---------------------------------------------------------------------
# Description:  STFdmm04 compares the mean distance between nodes 
#               generated by minimum spanning tree, unidirectional
#               minimum length path and bidirectional length path
#               The subset of WIG 20 (gwp.csv) and S&P 500 (close.csv) is
#               analysed.
# ---------------------------------------------------------------------
# Usage:        -
# ---------------------------------------------------------------------
...
# Inputs:       none
# ---------------------------------------------------------------------
# Output:       Comparison of the mean distance between nodes generated by 
#               minimum spanning tree, unidirectional minimum length path and
#               bidirectional length path.
#               The subset of WIG 20 and S&P 500 is analysed.
# ---------------------------------------------------------------------
# Example:      -
# ---------------------------------------------------------------------
...
par(mfrow=c(2,1))
plot(wynikWIG[,1], wynikWIG[,4],pch="*",ylab="mean distance",xlab="time",col="blue",ylim=c(min(wynikWIG[,4],wynikWIG[,2],wynikWIG[,3]),max(wynikWIG[,4],wynikWIG[,2],wynikWIG[,3])+0.07))
...
plot(wynikSP[,1], wynikSP[,4],pch="*",ylab="mean distance",xlab="time",col="blue",ylim=c(min(wynikSP[,4],wynikSP[,2],wynikSP[,3]),max(wynikSP[,4],wynikSP[,2],wynikSP[,3])+0.06))
