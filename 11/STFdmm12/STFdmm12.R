...
# Quantlet:     STFdmm12
# ---------------------------------------------------------------------
# Description:  STFdmm12 presents the statistical properties of the
#               minimum spanning tree as a function of time windows 
#               sizes for elements of the chosen WIG 20 companies (close.csv).
#               The Theil index based distance is used.
#               Requires theil.m, mst.m, manh.m to run the program (see 
#               quantnet).  Note that the {statistical toolbox} from 
#               Matlab is required as well.
# ---------------------------------------------------------------------
# Usage:        -
# ---------------------------------------------------------------------
# See also:     STFdmm01, STFdmm02, STFdmm03, STFdmm04, STFdmm05, 
#               STFdmm06, STFdmm07, STFdmm08, STFdmm09, STFdmm10, STFdmm11
# ---------------------------------------------------------------------
# Inputs:       none
# ---------------------------------------------------------------------
# Output:       Statistical properties of minimum spanning tree for
#               Theil index based distance matrix of WIG 20 companies.
# ---------------------------------------------------------------------
# Example:      -
# ---------------------------------------------------------------------
# Author:       Matlab: Janusz Miskiewicz
#               R: Awdesch Melzer 20121123
# ---------------------------------------------------------------------
