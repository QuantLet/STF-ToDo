...
#               results as a set of links for S&P 500 data set (close.csv).
...
companies = c("ABB","AAPL","BA","KO","EMR","GE","HPQ","HIT","IBM","INTC","JNJ","LMT","MSFT","NOC","NVS","CL","PEP","PG","TSEM","WEC") # company names
odl.true  = upper.tri(odl,1) # upper triangle
odl       = odl.true*odl


MST_UD    = cbind(as.character(companies[mst_odl[,1]]),as.character(companies[mst_odl[,2]]),as.numeric(round(mst_odl[,3],3))) # company i and j and MST
