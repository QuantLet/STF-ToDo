...
%               The procedure requires {statistical} package.
%               Requires mst.m and ultra.m to run the program (see 
%               quantnet).
% ---------------------------------------------------------------------
% Usage:        mst.m, ultra.m, umlp.m, blmp.m
% ---------------------------------------------------------------------
% See also:     mst, ultra, umlp, blmp, STFdmm01
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
