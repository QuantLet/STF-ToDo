...
# Quantlet:     STFdmm11
# ---------------------------------------------------------------------
# Description:  STFdmm11 presents the statistical properties of the
#               minimum spanning tree as a function of time windows 
#               sizes for elements of the chosen S&P 500 companies (close.csv).
#               The Theil index based distance is used.
# ---------------------------------------------------------------------
# Usage:        -
# ---------------------------------------------------------------------
# See also:     STFdmm01, STFdmm02, STFdmm03, STFdmm04, STFdmm05, 
#               STFdmm06, STFdmm07, STFdmm08, STFdmm09, STFdmm10
# ---------------------------------------------------------------------
# Inputs:       none
# ---------------------------------------------------------------------
# Output:       Statistical properties of minimum spanning tree for
#               Theil index based distance matrix of S&P 500 companies.
# ---------------------------------------------------------------------
# Example:      -
# ---------------------------------------------------------------------
