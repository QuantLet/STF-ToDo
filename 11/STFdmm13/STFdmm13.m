...
% Quantlet:     STFdmm13
% ---------------------------------------------------------------------
% Description:  STFdmm13 presents a comparison of the mean distance 
%               between nodes generated by minimum spanning tree, 
%               unidirectional minimum length path and bidirectional
%               length path.
%               The subset of S&P 500 and WIG 20 is analysed.
%               The Theil index based distance is used.
%               Requires ulmp.m,blmp.m, theil.m, mst.m, manh.m to run
%               the program (see quantnet).
% ---------------------------------------------------------------------
% Usage:        theil.m, mst.m, manh.m, ulmp.m, blmp.m,
% ---------------------------------------------------------------------
% See also:     theil, mst, manh, ulmp, blmp
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Statistical properties of minimum spanning tree for
%               Theil index based distance matrix of S&P 500 WIG 20
%               companies.
% ---------------------------------------------------------------------
% Example:      -
% ---------------------------------------------------------------------
