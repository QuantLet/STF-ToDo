...
% Quantlet:     STFhes04
% ---------------------------------------------------------------------
% Description:  STFhes04 plots the effect of changing model parameters
%               on the shape of the smile:
%               the innitial variance v_0 (top left panel),
%               volatility of variance sigma (top right panel), long-run
%               variance theta (bottom left panel), and mean revision
%               level kappa (bottom right) 
% ---------------------------------------------------------------------
...
% Inputs:       none
% ---------------------------------------------------------------------
% Output:       Plots showing the influence of the parameters
