...
# Quantlet:     STF2tvch03
# ------------------------------------------------------------------------------
# Description:  STF2tvch03 computes the mean absolute forecast error of the GARCH
#				volatility forecast based on the number "ghist" of past 
#				observations and plots the forecast
#               
# ------------------------------------------------------------------------------
# Usage:        -
# ------------------------------------------------------------------------------
...
#
------------------------------------------------------------------------------
# Output:       Plot of mean absolute forecast error of the GARCH volatility
#				forecast           
# ------------------------------------------------------------------------------
# Example:      Plot of mean absolute forecast error of the GARCH volatility
#				forecast based on the number "ghist" of past observations
# ------------------------------------------------------------------------------
# Author:       Pavel Cizek 20110715
# ------------------------------------------------------------------------------

# Computes the mean absolute forecast error of the GARCH volatility forecast based 
# on the number "ghist" of past observations and plots the forecast
