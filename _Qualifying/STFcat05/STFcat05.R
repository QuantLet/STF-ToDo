...
#             computes price of the CAT bond paying only coupons for the given 
#             claim amount distribution and the non-homogeneous 
#             Poisson process governing the flow of losses 
#----------------------------------------------------------------------------
# y = BondOnlyCoupon(C,D,T,r,lambda,parlambda,distr,params,Tmax,N)
#----------------------------------------------------------------------------
# Input:       
# Parameter:  C
...
wireframe(z~x+y, data=data, screen = list(z = 30, x = -60),
