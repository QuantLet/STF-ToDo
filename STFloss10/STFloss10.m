...
%               Burr claim sizes. The lines are the sample 0.001,
%               0.01, 0.05, 0.25, 0.50, 0.75, 0.95, 0.99, 0.999-quantile
%               lines based on 3000 trajectories of the risk process
%               (dfl.dat).
%               Requires simNHPPRP.m, simNHPPRPRT.m, quantiles.m, 
%               Paretornd.m, simNHPP.m, Burrrnd.m, mixexprnd.m, simHPP.m
%               from the Quantnet website.
% ---------------------------------------------------------------------
% Usage:        simNHPPRP.m, simNHPPRPRT.m, quantiles.m, Paretornd.m,
%               simNHPP.m, Burrrnd.m, mixexprnd.m, simHPP.m
% ---------------------------------------------------------------------
% See also:     STFloss01, STFloss02, SFTloss09, STFloss08, simNHPPRP, 
%               simNHPPRPRT, quantiles, Paretornd, simNHPP, 
%               Burrrnd, mixexprnd, simHPP
% ---------------------------------------------------------------------
% Inputs:       none
% ---------------------------------------------------------------------
