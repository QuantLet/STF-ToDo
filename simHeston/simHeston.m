...
% Quantlet:     simHeston
% ---------------------------------------------------------------------
% Description:  SIMHESTON sample trajectories of the spot price and volatility
% processes in the Heston model.
% ---------------------------------------------------------------------
% Usage:        simHeston
% ---------------------------------------------------------------------
% Inputs:       s0-starting value of the spot price process
%               N- time endpoint  
%               mu-drift
...
% ---------------------------------------------------------------------
% Author:      Written in XploRe by Rafal Weron (20040521)
%              Ported to Matlab and added functionality by %Agnieszka Janek 
%              (20100707, 20100913)
%              Revised by Rafal Weron (20101227)
% ---------------------------------------------------------------------
